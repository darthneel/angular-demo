...
myAppModule.controller('SuperHeroController', ['$scope', function($scope) {
  ...
  $scope.addSuperhero = function() {  
    superheroList.push($scope.newSuperhero);    
    $scope.newSuperhero = false    
    $scope.superheroForm.$setPristine();
  }
